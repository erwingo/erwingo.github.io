...
describe('Grid', () => {
  it('should get correct grid dimensions with no margin', () => {
    deepEqual(gridHelpers.getGridDimensions(500, 10), { dimension: 50, gap: 0 })
    deepEqual(gridHelpers.getGridDimensions(699, 10), { dimension: 69, gap: 9 })
  })

  it('should get correct grid dimensions with margin', () => {
    deepEqual(gridHelpers.getGridDimensions(500, 10, 10), { dimension: 39, gap: 0 })
    deepEqual(gridHelpers.getGridDimensions(699, 10, 10), { dimension: 58, gap: 9 })
  })
