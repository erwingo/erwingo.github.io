...
export default function Card(props: Props) {
  ...
  useEffect(() => {
    ...
    if (parsedUrl?.slice(0, 3) === 'TV-') {
      ...
      parsedUrl = `https://www.twitch.tv/embed/${parsedUrl.slice(3)}/chat?darkpopout`;
    }
  ...
  return (
    <div className="Card">
      <div className="Card__placeholder" onClick={e => (e.preventDefault(), props.onPlaceholderClick()) } />
